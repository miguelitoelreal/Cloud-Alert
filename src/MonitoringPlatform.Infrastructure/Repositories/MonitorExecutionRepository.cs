    ...
    public class MonitorExecutionRepository : IMonitorExecutionRepository
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var log = new MonitorLog
            {
                ...
                DnsTimeMs = dto.DnsTimeMs,
                ConnectTimeMs = dto.ConnectTimeMs,
                TlsTimeMs = dto.TlsTimeMs,
                TtfbTimeMs = dto.TtfbTimeMs,
            ...
            return new RecordedMonitorCheckDto
            {
                Monitor = new DashboardMonitorSummaryDto
                {
                    ...
                    LastDnsTimeMs = dto.DnsTimeMs,
                    LastConnectTimeMs = dto.ConnectTimeMs,
                    LastTlsTimeMs = dto.TlsTimeMs,
                    LastTtfbTimeMs = dto.TtfbTimeMs,
