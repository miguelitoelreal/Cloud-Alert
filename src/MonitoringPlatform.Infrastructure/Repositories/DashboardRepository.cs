            ...
            return monitors
                .Select(m =>
                {
                    ...
                    return new DashboardMonitorSummaryDto
                    {
                        ...
                        LastDnsTimeMs = hasLatestLog ? latestLog!.DnsTimeMs : null,
                        LastConnectTimeMs = hasLatestLog ? latestLog!.ConnectTimeMs : null,
                        LastTlsTimeMs = hasLatestLog ? latestLog!.TlsTimeMs : null,
                        LastTtfbTimeMs = hasLatestLog ? latestLog!.TtfbTimeMs : null,
