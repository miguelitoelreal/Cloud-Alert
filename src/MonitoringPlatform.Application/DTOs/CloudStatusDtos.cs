...
namespace MonitoringPlatform.Application.DTOs
{
    ...
    public class CloudStatusProviderIngestionResultDto
    {
        ...
        public List<Guid> InsertedIds { get; set; } = [];
    ...
    public class CloudProviderTrendPointDto
    {
    ...
    public class CloudProviderTrendDto
    {
        public string ProviderSlug { get; set; } = string.Empty;
        public string ProviderName { get; set; } = string.Empty;
        public List<CloudProviderTrendPointDto> Points { get; set; } = [];
    }
