...
const AlertSubscriptionsPage = lazy(() => import("../pages/AlertSubscriptionsPage").then((m) => ({ default: m.AlertSubscriptionsPage })));
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            element: <Suspense fallback={<PageLoader />}><AlertSubscriptionsPage /></Suspense>,
          },
          {
            path: "sla-dashboard",
