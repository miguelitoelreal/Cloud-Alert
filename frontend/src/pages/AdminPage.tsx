    ...
    <div className="mx-auto max-w-4xl space-y-6">
          ...
          <div className="space-y-4">
            ...
            <form onSubmit={handleCreateUser} className="flex flex-col gap-3 sm:flex-row sm:items-end">
              <div className="min-w-0 flex-1">
                <label className="block text-xs font-medium text-slate-500 dark:text-slate-400">Nombre</label>
                <input
                  type="text"
                  value={newName}
                  onChange={(e) => setNewName(e.target.value)}
                  placeholder="Nombre completo"
                  className="mt-1 block w-full rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 px-3 py-2 text-sm text-slate-900 dark:text-slate-100 shadow-sm placeholder:text-slate-600 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                  required
                />
              </div>
              <div className="min-w-0 flex-1">
              ...
              <div className="min-w-0 flex-1">
                <label className="block text-xs font-medium text-slate-500 dark:text-slate-400">Contrasena</label>
                <input
                  type="password"
                  value={newPassword}
              ...
              <div className="flex items-center gap-2 pb-2">
                ...
                />
                <label htmlFor="new-is-admin" className="text-xs text-slate-500 dark:text-slate-400">
                  Admin
                </label>
              </div>
                      ...
                      return (
                        <tr key={u.id} className="border-b border-slate-200 dark:border-slate-800">
                          {editingUserId === u.id ? (
                              ...
                              <td className="py-2 pr-4" colSpan={2}>
                                ...
                                >
                                  <input
                                    ...
                                    placeholder="Nombre"
                                    className="rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 px-2 py-1 text-sm text-slate-900 dark:text-slate-100 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                                    required
                                  />
                                  <input
                                    type="email"
                              ...
                              <td className="py-2">
                                <div className="flex items-center gap-2">
                                  ...
                                  <button
                                    ...
                                    className="text-xs text-slate-500 hover:text-slate-700 dark:text-slate-300 hover:underline"
                                  >
                                    Cancelar
                                  </button>
                                </div>
                            ...
                            <>
                              <td className="py-2 pr-4 text-slate-800 dark:text-slate-200">{u.name}</td>
      ...
      {activeTab === "email" && (
        <Card title="Configuracion de correo">
          {emailLoading ? (
            <div className="text-xs text-slate-500 dark:text-slate-400">Cargando configuracion…</div>
          ) : (
            <div className="space-y-6">
              ...
              {/* Status card */}
              <div className="rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900/40 p-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className={`flex h-10 w-10 items-center justify-center rounded-full ${emailConfig.emailEnabled ? "bg-emerald-500/10 text-emerald-400" : "bg-slate-700 text-slate-500 dark:text-slate-400"}`}>
                      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                        <path d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                    </div>
                    <div>
                      <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">Envio de emails</p>
                  ...
                  <span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${emailConfig.emailEnabled ? "bg-emerald-500/10 text-emerald-400" : "bg-slate-700 text-slate-500 dark:text-slate-400"}`}>
              ...
              {!isEditingEmail ? (
                /* Read-only summary */
                <div className="space-y-4">
                  <div className="rounded-xl border border-slate-300 dark:border-slate-700/60 bg-white dark:bg-slate-900/30 p-4">
                      ...
                      {emailConfig.emailProvider === "Smtp" ? (
                        <>
                          <div>
                            ...
                            <p className="text-sm font-medium text-slate-800 dark:text-slate-200">{emailConfig.smtpHost || "—"}</p>
                          </div>
                          <div>
                            <p className="text-[10px] font-medium uppercase tracking-wider text-slate-600">Puerto</p>
                            <p className="text-sm font-medium text-slate-800 dark:text-slate-200">{emailConfig.smtpPort || "—"}</p>
                          </div>
                          <div>
                            <p className="text-[10px] font-medium uppercase tracking-wider text-slate-600">Usuario</p>
                            <p className="text-sm font-medium text-slate-800 dark:text-slate-200">{emailConfig.smtpUsername || "—"}</p>
                          </div>
                          <div>
                            <p className="text-[10px] font-medium uppercase tracking-wider text-slate-600">Contrasena</p>
                            <p className="text-sm font-medium text-slate-800 dark:text-slate-200">{emailConfig.smtpPassword ? "••••••••" : "—"}</p>
                          </div>
                          <div>
                            <p className="text-[10px] font-medium uppercase tracking-wider text-slate-600">SSL / TLS</p>
                            <p className="text-sm font-medium text-slate-800 dark:text-slate-200">{emailConfig.useSsl ? "Activado" : "Desactivado"}</p>
                          </div>
                        </>
                      ) : (
                        <div>
                          <p className="text-[10px] font-medium uppercase tracking-wider text-slate-600">API Key</p>
                          <p className="text-sm font-medium text-slate-800 dark:text-slate-200">{emailConfig.brevoApiKey ? "••••••••" : "—"}</p>
                        </div>
                      )}
                      <div>
                        <p className="text-[10px] font-medium uppercase tracking-wider text-slate-600">Email remitente</p>
                        <p className="text-sm font-medium text-slate-800 dark:text-slate-200">{emailConfig.senderEmail || "—"}</p>
                      </div>
                      <div>
                        <p className="text-[10px] font-medium uppercase tracking-wider text-slate-600">Nombre remitente</p>
                        <p className="text-sm font-medium text-slate-800 dark:text-slate-200">{emailConfig.senderName || "—"}</p>
                      </div>
                    </div>
                  </div>
                ...
                <form onSubmit={handleSaveEmail} className="space-y-6">
                  ...
                  {emailConfig.emailEnabled ? (
                    <>
                      <div className="space-y-4">
                        <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">Proveedor</p>
                          ...
                          <button
                            ...
                            className={`flex flex-1 items-center justify-center gap-2 rounded-lg border px-4 py-3 text-sm font-medium transition-colors ${
                              emailConfig.emailProvider === "Smtp"
                                ...
                                : "border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900/40 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:bg-slate-800"
                            }`}
                          >
                            <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                      ...
                      {emailConfig.emailProvider === "Smtp" ? (
                        <>
                          <div className="space-y-4">
                            <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">Servidor de salida</p>
                            <div className="grid gap-4 sm:grid-cols-2">
                              <div>
                                <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Servidor SMTP</label>
                                <input
                                  type="text"
                                  ...
                                  required
                                  className="block w-full rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 px-3 py-2 text-sm text-slate-900 dark:text-slate-100 shadow-sm placeholder:text-slate-600 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                                />
                              </div>
                              <div>
                                <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Puerto</label>
                                <input
                                  type="number"
                                  value={emailConfig.smtpPort}
                                  onChange={(e) => setEmailConfig((c) => ({ ...c, smtpPort: Number(e.target.value) }))}
                                  required
                                  className="block w-full rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 px-3 py-2 text-sm text-slate-900 dark:text-slate-100 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                                />
                              </div>
                              <div>
                                <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Usuario SMTP</label>
                                <input
                                  type="text"
                              ...
                              <div>
                                <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Contrasena SMTP</label>
                                <input
                                  type="password"
                        ...
                        <div className="space-y-4">
                          <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">Credenciales Brevo</p>
                          <div>
                      ...
                      <div className="space-y-4">
                        <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">Remitente</p>
                        <div className="grid gap-4 sm:grid-cols-2">
                          <div>
                            <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Email remitente</label>
                            <input
                              type="email"
                          ...
                          <div>
                            <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Nombre remitente</label>
                            <input
                              type="text"
                    ...
                    <div className="rounded-lg border border-slate-300 dark:border-slate-700/60 bg-white dark:bg-slate-900/30 p-6 text-center">
                  ...
                  <div className="flex justify-end gap-2 border-t border-slate-300 dark:border-slate-700 pt-4">
                    <button
                      type="button"
                      onClick={handleCancelEmailEdit}
                      className="inline-flex items-center gap-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-transparent px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 transition hover:bg-slate-100 dark:bg-slate-800"
                    >
                      Cancelar
                    </button>
