...
## Notas sobre el registro y roles de usuario

**Importante:**
La primera vez que un usuario se registra en la plataforma, se le asigna automáticamente el rol de **administrador**. Algunas funcionalidades para este rol aún no están implementadas.

Si quieres probar la plataforma como un usuario normal (no administrador):

1. Cierra la sesión de la cuenta creada recientemente (administrador).
